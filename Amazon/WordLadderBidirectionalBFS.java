...
public class WordLadderBidirectionalBFS {
    ...
    public static int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        return biBFS(beginSet, endSet, dict, 1);

    }


    private static int biBFS(Set<String> beginSet, Set<String> endSet, Set<String> dict, int step) {
        if(beginSet.size() == 0) {
            return 0;
        }
    ...
    public static int ladderLengthII(String beginWord, String endWord, List<String> wordList) {
        ...
        return biBFSII(beginSet, endSet, dict, 1);
    }

    public static int biBFSII(Set<String> beginSet, Set<String> endSet, Set<String> dict, int step) {
        if(beginSet.size() == 0) {
            return 0;
        }else if(beginSet.size() > endSet.size()) {
            return biBFSII(endSet, beginSet, dict, step);
        }
        ...
        return biBFSII(nextLevel, endSet, dict, step + 1);
    }
